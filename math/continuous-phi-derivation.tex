...
of regions. The classic approach discretises $\phi$ on a grid and profiles
...
exactly the temporal-range derivatives already used in the spatio-temporal code,
with $\phi$ in place of the Mat\'ern range. The asymptotic
